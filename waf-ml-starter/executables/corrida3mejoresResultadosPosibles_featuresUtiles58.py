...
# -*- coding: utf-8 -*-
"""
Corrida3MejoresResultadosPosiblesFeaturesUtiles58 multiclase WAF-ML para TorpEda y Harvard/SR-BH.
...
- Guarda TODO bajo corrida3mejoresResultadosPosibles_featuresUtiles58/multiclase/{torpeda,harvard}.
...
DEFAULT_RESULT_DIR_NAME = "corrida3mejoresResultadosPosibles_featuresUtiles58"
...
FEATURE_SET_VERSION = "corrida3_useful58_from_per_class_fi_v1"
...
def train_eval_one_dataset(args: argparse.Namespace, dataset: str) -> Dict[str, Any]:
    ...
    print("================================================================", flush=True)
    print(f"[START] {dataset} corrida3mejoresResultadosPosibles_featuresUtiles58 multiclase HistGradientBoosting @ {_now_iso()}", flush=True)
    ...
    processed_path = _save_processed(df, out_dir / "processed_useful58.parquet")
    ...
    model_path = out_dir / "model_multiclass_histgb_useful58.joblib"
    joblib.dump({
        "task": "multiclass",
        "dataset": dataset,
        "model": model,
    ...
    metrics_payload: Dict[str, Any] = {
        ...
        "artifacts": {
            ...
            "metrics": str(out_dir / "metrics_multiclass_histgb_useful58.json"),
    ...
    _save_json(metrics_payload, out_dir / "metrics_multiclass_histgb_useful58.json")
    ...
    for p in [
        processed_path,
        model_path,
        out_dir / "metrics_multiclass_histgb_useful58.json",
...
def write_aggregate_outputs(args: argparse.Namespace, payloads: Sequence[Dict[str, Any]]) -> None:
    ...
    df.to_csv(root / "model_comparison_multiclass_corrida3mejoresResultadosPosibles_featuresUtiles58.csv", index=False)
    _save_json({
        "created_at": _now_iso(),
        "task": "multiclass",
        "model_family": "hist_gradient_boosting",
        ...
        "rows": rows,
        "artifacts": {
            "comparison_csv": str(root / "model_comparison_multiclass_corrida3mejoresResultadosPosibles_featuresUtiles58.csv"),
            "comparison_json": str(root / "model_comparison_multiclass_corrida3mejoresResultadosPosibles_featuresUtiles58.json"),
        },
    }, root / "model_comparison_multiclass_corrida3mejoresResultadosPosibles_featuresUtiles58.json")
    _save_json({
        "created_at": _now_iso(),
    ...
    }, Path(args.definitivo_dir) / "manifest_corrida3mejoresResultadosPosibles_featuresUtiles58.json")
    print(f"[OK] Aggregate comparison: {root / 'model_comparison_multiclass_corrida3mejoresResultadosPosibles_featuresUtiles58.csv'}", flush=True)
...
def parse_args(argv: Optional[Sequence[str]] = None) -> argparse.Namespace:
    ap = argparse.ArgumentParser(description="corrida3mejoresResultadosPosibles_featuresUtiles58 multiclase: HistGradientBoosting con 58 features intra-request útiles; Harvard top14-combo por defecto")
    ...
    ap.add_argument("--definitivo-dir", "--result-dir", dest="definitivo_dir", default=None, help="Default: PROJECT_DIR/corrida3mejoresResultadosPosibles_featuresUtiles58")
    ...
    ap.add_argument("--output-dir", default=None, help="Solo para --dataset torpeda/harvard: sobreescribe corrida3mejoresResultadosPosibles_featuresUtiles58/multiclase/{dataset}.")
    ...
    if args.dataset == "both" and args.output_dir:
        raise SystemExit("--output-dir solo se usa con --dataset torpeda o --dataset harvard; con both se usa corrida3mejoresResultadosPosibles_featuresUtiles58/multiclase/{dataset}.")
