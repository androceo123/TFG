...
#SBATCH --mem=32G
# disabled for CPU: #SBATCH --gres=gpu:1
# disabled for CPU: #SBATCH --exclusive
#SBATCH --time=3-00:00:00
#SBATCH --chdir=/home_data/aroman/TFG/waf-ml-starter
#SBATCH --output=/home_data/aroman/TFG/waf-ml-starter/DEFINITIVO_multilabel_xgboost_gpu_c2_%j.out
#SBATCH --error=/home_data/aroman/TFG/waf-ml-starter/DEFINITIVO_multilabel_xgboost_gpu_c2_%j.err
...
#   sbatch -p normal -w c2 --gres=gpu:1 --exclusive --cpus-per-task=32 --mem=0 DEFINITIVO/multietiqueta/run_DEFINITIVO_multilabel_harvard_xgboost_none_fixed30_arandu_c2_gpu_metrics.sh
#
...
LOG_PREFIX="${DEFINITIVO_DIR}/multietiqueta/logs/definitivo_multilabel_harvard_xgboost_gpu_c2_${SLURM_JOB_ID:-manual}"
